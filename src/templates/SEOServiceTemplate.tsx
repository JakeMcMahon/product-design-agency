...
interface SEOServiceTemplateProps {
  serviceName: string;
  heroTitle: string;
  heroSubtitle: string;
...
export const SEOServiceTemplate: React.FC<SEOServiceTemplateProps> = ({
  serviceName,
  heroTitle,
  heroSubtitle,
  metaDescription,
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <head>
        <title>{serviceName} - AI Automation RU</title>
      ...
      <ConsultationPopupRU
        ...
        title={`Получите предложение по ${serviceName}`}
