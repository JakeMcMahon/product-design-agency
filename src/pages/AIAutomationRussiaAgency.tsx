...
export const AIAutomationRussiaAgency = (): JSX.Element => {
  return (
    <main className="bg-white min-h-screen w-full overflow-x-hidden" data-model-id="2:4">
      <div className="bg-white w-full flex flex-col">
        ...
        <section id="cases" className="w-full translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:150ms] mt-20">
          <ClientResultsSection />
        </section>
        <section id="process" className="w-full translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
          <MainContentSection />
        </section>
